...
float eyeLeftRelativeX  = 5   ,  eyeLeftRelativeY  = 5;   //ændrede int til float så det kunne arbejde med decimal tal
float eyeRightRelativeX = 15  ,  eyeRightRelativeY = 5;   //ændrede int til float så det kunne arbejde med decimal tal   
...
void draw() {                         
  ...
  clear();
  ellipse(ballX + ballwalk, ballY + ballwalk, ballSize + ballwalk, ballSize + ballwalk);
